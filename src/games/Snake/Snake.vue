 ...
 * File: Snake.vue                                                             *
 * Project: alarmclock                                                         *
 * File Created: Monday,1st July 2019 09:53:15 am                              *
 * Author: Le Phoque Pirate                                                    *
 * --------------------                                                        *
 * Last Modified: Monday, 1st July 2019 2:05:02 pm                             *
 * Modified By: Le Phoque Pirate (tcousin@intechinfo.fr)                       *
 */

<template>
  <div v-if="this.GameIsOn == false">
    <button v-on:click="StartUp()">Jouer</button>
  </div>
...
export default {
  ...
  methods: {
    ...
    IsFoodEated: function() {
      if (
        this.Arena.Snake.Tail[0].X == this.Arena.Food.X &&
